...
// In index.html, uncomment the div element containing the meatloaf recipe
// (lines 16-20). 
// Update your code above so only the 3 recipes in the `favorites` variable
// are displayed, and the meatloaf recipe is removed from the DOM.

/*
$(function () {
  let content = '';
  favorites.recipe.forEach(function (favorite) {
    content += (template(favorite));
  });
